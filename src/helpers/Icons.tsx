            ...
            return (
                <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <path fill={colorClassName === "" ? "#FFD66B" : "currentColor"}
                          className={colorClassName!} fillRule="evenodd" clipRule="evenodd"
        ...
        case IconType.Streak:
            return (
                <svg width={size} height={size} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path className={colorClassName!} d="M6.25 6.69588C6.25 5.52577 4.67083 5.21564 4.25186 6.31046C3.23842 8.95879 2.5 11.3278
                    2.5 12.6087C2.5 16.6908 5.85787 20 10 20C14.1421 20 17.5 16.6908 17.5 12.6087C17.5 11.2326 16.6477
                    8.60046 15.5176 5.71533C14.0539 1.97803 13.3219 0.109373 12.4184 0.00871858C12.1294 -0.0234777 11.814
                    0.0344254 11.5561 0.167054C10.75 0.581585 10.75 2.61968 10.75 6.69588C10.75 7.92047 9.7426 8.91326 8.5 8.91326C7.2574
                    8.91326 6.25 7.92047 6.25 6.69588Z" />
                </svg>
            )
        case IconType.Time:
            return (
